...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO book (pickup, return, pickupLoc, dropLoc, fullName, email, phone, idNo) VALUES (%s, %s, %s, %s, %s, %s, %s, %s)",
                       GetSQLValueString($_POST['pickup'], "date"),
                       GetSQLValueString($_POST['return'], "date"),
                       GetSQLValueString($_POST['pickupLoc'], "text"),
                       GetSQLValueString($_POST['dropLoc'], "text"),
...
<body>
  ...
  <p class="lead">Quick, secure reservation — get confirmation by SMS & email. You must be signed in to confirm a booking.</p>
      ...
      <form method="POST" action="<?php echo $editFormAction; ?>" name="form1" id="bookingForm" novalidate>
        <fieldset>
  ...
  if(summary) summary.setAttribute('aria-hidden','false');
    ...
    bookingForm.addEventListener('submit', (e)=>{
      ...
      // Replace here with actual POST to your bookings API
